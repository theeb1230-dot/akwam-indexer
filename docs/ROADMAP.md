...
- المتبقي قبل إعلان Web/PWA مكتملة: polishing نهائي للهوية، ثم نشر مجاني موثق أو أفضل بديل مجاني متاح. اختبار متصفح فعلي للـPWA أصبح مغطى داخل CI عبر Chromium.
