...
- Android TV: أضيف مسار بناء مستقل بتهيئة Leanback وعدم اشتراط اللمس، وتمرير `android_tv` في playback contract. لا يُعد TV جاهزًا نهائيًا قبل نجاح بوابة APK الخاصة به على CI.
