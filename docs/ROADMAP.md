...
- التسجيل المنظم ومراقبة الصحة: طلبات HTTP وقياسات الصحة موجودة؛ أخطاء HTTP الداخلية، وجدولة health/refresh، ودورة حياة الـworkers والـheartbeat تمر الآن عبر logger منقح ومحدود الحقول. ما زال توحيد بقية سجلات routes/services متبقيًا.
