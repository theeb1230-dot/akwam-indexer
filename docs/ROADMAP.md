...
- التسجيل المنظم ومراقبة الصحة: طلبات HTTP وقياسات الصحة موجودة؛ أخطاء HTTP الداخلية أصبحت تمر عبر logger منقح ومحدود الحقول، وما زال توحيد بقية سجلات workers/routes متبقيًا.
