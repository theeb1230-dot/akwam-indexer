...
- التسجيل المنظم موجود لمسارات HTTP الحرجة وserver/workers/schedulers مع request IDs وredaction موحد؛ المتبقي توسيع metrics/alerts التشغيلية بدون خدمة مدفوعة.
