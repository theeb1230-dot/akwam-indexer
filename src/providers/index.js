...
registry.register("akwam", akwam);
registry.register("arabseed", arabseed);
registry.register("wecima", wecima);
registry.register("shahid4u", shahid4u);
registry.register("lodynet", lodynet);
registry.register("qask", qask);
registry.register("cimaleek", cimaleek);
registry.register("laaroza", laaroza);
