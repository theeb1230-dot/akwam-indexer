...
class LodyNetProvider {
  constructor() {
    this.name = "lodynet";
    this.baseUrl = "https://lodynet.watch";
  ...
  scoreCandidate(
    ...
    const candidate =
      this.clean(
        `${candidateText} ${this.decodePath(candidateUrl)}`
      ).toLowerCase();
  ...
  async search(query) {
    ...
    $("a[href]").each(
      (_, element) => {
        ...
        /*
         * يجب أن يحتوي المرشح على كلمات البحث.
         * هذا يمنع إدخال Categories عامة.
         */
        const score =
          this.scoreCandidate(
            title,
